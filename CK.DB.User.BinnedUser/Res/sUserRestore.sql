-- SetupConfig: {}
--
-- Restores a previously archived user by clearing CK.tUser.BinDate.
...
begin
    ...
    -- By default, only members of the Administrators group (GroupId 2) can restore a user.
    ...
    --<RestoreSecurityCheck revert />

    if @CanContinue = 0 throw 50000, 'Security.PlatformAdministratorOnly', 1;

    update CK.tUser
        set BinDate = null
        where UserId = @UserId and BinDate is not null;
